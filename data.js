...
語氣正式，適合直接寄給主管。</pre>
  ...
  {id:'a6',date:'2026-08-04',cover:'images/a6-cover-godzilla.webp',tags:['職安衛','法規','化學品'],title:'化學品到底危不危險？看懂 GHS 分類與 SDS 安全資料表，一次搞懂危害通識',
   excerpt:'工廠裡的那桶丙酮到底有多危險？答案就藏在瓶子上的象形圖和一份 16 頁的 SDS 裡。本文帶你看懂 GHS 三大危害分類、9 種象形圖的意義，以及 SDS 現場最實用的四節，讓危害通識不再只是教育訓練上的過場。',
   body:`<img src="images/a6-cover-godzilla.webp" alt="GHS 分類與 SDS 安全資料表危害通識">
   <div class="notion-asset-caption">看懂標示、讀懂 SDS，化學品危害一目了然</div>

   <div class="summary-box"><div class="summary-title">🎯 這篇文章帶你搞懂</div>
   <ul>
     <li>GHS 是什麼、台灣法規從哪一年開始採用、法源在哪裡</li>
     <li>三大危害分類（物理性／健康／環境）各自包含哪些危害</li>
     <li>9 種 GHS 象形圖看到就要知道代表什麼風險</li>
     <li>SDS 16 節中現場最實用的四節怎麼讀</li>
     <li>入廠前、現場作業中、教育訓練時，三個時間點的實務確認清單</li>
   </ul></div>

   <p>先從一個具體情境開始：你走進廠房，架上放著一桶標示「丙酮（Acetone）」的容器，旁邊有個火焰狀的橘色菱形圖示、一個骷髏頭、還有「危險」兩個字。這三樣東西，加上夾在架上的那份安全資料表（SDS），就是你判斷「這個化學品有多危險、我要怎麼保護自己」的全部資訊來源。問題是：大多數人看了等於沒看。</p>
   <p>GHS 和 SDS 不是只拿來貼在牆上讓稽核拍照的。它們是真正的操作工具——前提是你看得懂。</p>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>一、GHS 是什麼？台灣從什麼時候開始採用</h4>
   <p>GHS 全稱「全球化學品統一分類及標示制度（Globally Harmonized System）」，是聯合國推動的國際標準，目的是讓全世界對化學品危害的分類邏輯和標示方式一致，不管是日本出口的溶劑還是台灣在地生產的清潔劑，看到象形圖的人都能理解同一個意思。</p>
   <p>台灣的法源是《<a href="https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=N0060041" target="_blank" rel="noopener">危害性化學品標示及通識規則</a>》（職業安全衛生法授權子法），自民國 105 年（2016 年）起全面採用 <b>GHS 第四版格式</b>，也就是現行的 CNS 15030 系列標準。雇主對於具有危害性的化學品，有義務依規則完成標示與提供 SDS，若未依規定標示，最高可處 NT$30 萬元罰鍰。</p>

   <img src="images/a6-ghs-godzilla.webp" alt="GHS 9種化學品危害象形圖對照" style="max-width:100%;border-radius:12px;margin:12px 0 20px">
   <div class="notion-asset-caption">GHS 9 種危害象形圖——辨識危害，預防風險，保護自己</div>

   <div class="tip-box tip-info">💡 <b>GHS 與 CNS 15030 的關係</b>：GHS 是聯合國發布的國際制度框架，CNS 15030 是台灣經濟部標準局根據 GHS 制定的國家標準，兩者架構高度一致，差別在於 CNS 15030 的中文化與部分本地化調整。實務上只需要依照「危害性化學品標示及通識規則」的規定執行即可。</div>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>二、GHS 三大危害分類</h4>
   <p>GHS 把化學品危害拆成三個大類，每個大類底下再細分不同的危害類型和級別（Class & Category）。級別數字越小，代表危害程度越高（第 1 級最嚴重）。</p>

   <table>
     <thead><tr><th>大類</th><th>包含危害類型（舉例）</th><th>常見例子</th></tr></thead>
     <tbody>
       <tr><td><b>物理性危害</b><br><span style="font-size:13px;color:var(--text3)">Physical Hazards</span></td><td>易燃液體、易燃氣體、爆炸物、氧化性液體、加壓氣體、自反應物質、自燃液體等 16 類</td><td>丙酮（易燃液體第 2 級）、乙炔（易燃氣體）、雙氧水（氧化性液體）</td></tr>
       <tr><td><b>健康危害</b><br><span style="font-size:13px;color:var(--text3)">Health Hazards</span></td><td>急毒性、皮膚腐蝕／刺激、嚴重眼睛損傷、皮膚過敏、致癌性、生殖毒性、特定標的器官毒性等 10 類</td><td>鹽酸（皮膚腐蝕）、苯（致癌性第 1A 類）、二氧化矽粉塵（特定標的器官毒性）</td></tr>
       <tr><td><b>環境危害</b><br><span style="font-size:13px;color:var(--text3)">Environmental Hazards</span></td><td>危害水環境（急性及慢性）、危害臭氧層 2 類</td><td>部分溶劑、界面活性劑（水環境急性危害）</td></tr>
     </tbody>
   </table>

   <p>以丙酮為例，它的危害分類是：物理性危害（易燃液體 第2級）+ 健康危害（眼睛刺激 第2級、特定標的器官毒性 第3級）。這也是為什麼丙酮桶上同時出現火焰和驚嘆號兩個象形圖。</p>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>三、9 種 GHS 象形圖，看到就要懂</h4>
   <p>GHS 象形圖是紅色邊框的白底菱形，裡面的黑色符號代表不同的危害類型。現行共有 9 種，對應到不同的危害大類：</p>

   <table>
     <thead><tr><th>象形圖</th><th>危害意涵</th><th>對應常見物質</th></tr></thead>
     <tbody>
       <tr><td>🔥 火焰</td><td>易燃液體、氣體、固體；自燃物質；自反應物質</td><td>丙酮、甲醇、乙醚</td></tr>
       <tr><td>💥 爆炸彈</td><td>爆炸物、自反應物質（部分）、有機過氧化物（部分）</td><td>硝化甘油、TNT</td></tr>
       <tr><td>🔴 火焰圓圈</td><td>氧化性氣體、液體、固體</td><td>雙氧水高濃度、氯氣</td></tr>
       <tr><td>🟤 氣瓶</td><td>加壓氣體（壓縮氣體、液化氣體）</td><td>氮氣鋼瓶、CO₂滅火鋼瓶</td></tr>
       <tr><td>⚗️ 腐蝕</td><td>皮膚腐蝕、金屬腐蝕</td><td>鹽酸、硫酸、氫氧化鈉</td></tr>
       <tr><td>☠️ 骷髏頭</td><td>急毒性 第1-3級（高度危險）</td><td>氰化鉀、高濃度甲醇</td></tr>
       <tr><td>❗ 驚嘆號</td><td>急毒性第4級、皮膚／眼睛刺激、皮膚過敏、麻醉性</td><td>丙酮（眼睛刺激）、部分清潔劑</td></tr>
       <tr><td>🫁 健康危害</td><td>致癌性、生殖毒性、呼吸道過敏、特定標的器官毒性（嚴重）</td><td>苯、石棉、甲醛</td></tr>
       <tr><td>🐟 環境</td><td>危害水環境（急性或慢性）</td><td>部分有機溶劑、農藥</td></tr>
     </tbody>
   </table>

   <div class="tip-box tip-warn">⚠️ <b>驚嘆號≠不危險</b>：很多人看到驚嘆號覺得「還好，不是骷髏頭」，但驚嘆號對應的皮膚過敏、眼睛刺激、麻醉性，在長期接觸或高濃度暴露下一樣會造成職業傷病。象形圖的危害級別要搭配 SDS 第 2 節一起讀，才知道實際嚴重程度。</div>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>四、警示語與危害警示訊息</h4>
   <p>標示上除了象形圖，還有兩個關鍵要素：</p>
   <ul style="margin:10px 0 16px 20px;line-height:2">
     <li><b>警示語（Signal Word）</b>：只有兩種——「<b>危險</b>」（Danger）代表較嚴重的危害等級；「<b>警告</b>」（Warning）代表較低等級。同一個化學品若有多個危害，取最嚴重的那個警示語。</li>
     <li><b>危害警示訊息（H-codes，Hazard Statements）</b>：如 H225 代表「高度易燃液體及蒸氣」、H336 代表「可能導致昏睡或眩暈」。丙酮通常同時帶 H225 + H319 + H336 三個 H-code。</li>
   </ul>
   <p>這些 H-code 不是隨便寫的——它們直接連結到 SDS 第 2 節的危害辨識，知道 H-code 就等於知道去 SDS 哪裡找防護重點。</p>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>五、SDS 安全資料表：16 節的結構</h4>
   <img src="images/a6-sds-godzilla.webp" alt="SDS 安全資料表 16節結構" style="max-width:100%;border-radius:12px;margin:12px 0 20px">
   <div class="notion-asset-caption">SDS 共 16 節，第 2、4、7、8 節是現場最實用的四節</div>
   <p>SDS（Safety Data Sheet，舊稱 MSDS）是化學品的「使用說明書 + 緊急應變指南」，由製造商或進口商提供，法定要求提供中文版。16 節的架構如下：</p>

   <table>
     <thead><tr><th>節次</th><th>內容</th><th>重要性</th></tr></thead>
     <tbody>
       <tr><td>第 1 節</td><td>化學品與廠商資料</td><td>確認是否與容器標示一致</td></tr>
       <tr><td><b>第 2 節</b></td><td><b>危害辨識</b></td><td>⭐ 現場必讀</td></tr>
       <tr><td>第 3 節</td><td>成分辨識資料</td><td>混合物時確認各成分</td></tr>
       <tr><td><b>第 4 節</b></td><td><b>急救措施</b></td><td>⭐ 現場必讀</td></tr>
       <tr><td>第 5 節</td><td>滅火措施</td><td>消防演練、緊急應變</td></tr>
       <tr><td>第 6 節</td><td>洩漏緊急處理</td><td>事故應變</td></tr>
       <tr><td><b>第 7 節</b></td><td><b>安全處置與儲存</b></td><td>⭐ 現場必讀</td></tr>
       <tr><td><b>第 8 節</b></td><td><b>暴露預防措施</b></td><td>⭐ 現場必讀</td></tr>
       <tr><td>第 9 節</td><td>物理及化學性質</td><td>閃火點、沸點等工程控制參考</td></tr>
       <tr><td>第 10 節</td><td>安定性及反應性</td><td>儲存不相容物質確認</td></tr>
       <tr><td>第 11 節</td><td>毒性資料</td><td>職業傷病評估</td></tr>
       <tr><td>第 12 節</td><td>生態資料</td><td>環境法規合規</td></tr>
       <tr><td>第 13 節</td><td>廢棄處置方法</td><td>廢棄物申報</td></tr>
       <tr><td>第 14 節</td><td>運送資料</td><td>危險物品運輸</td></tr>
       <tr><td>第 15 節</td><td>法規資料</td><td>確認適用管制法規</td></tr>
       <tr><td>第 16 節</td><td>其他資料</td><td>版本日期、修訂記錄</td></tr>
     </tbody>
   </table>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>六、現場最實用的四節，這樣讀</h4>

   <p><b>第 2 節：危害辨識</b><br>
   這節會列出所有 GHS 分類結果、象形圖、警示語、H-code，還有「其他危害」補充說明。讀這節的目的是快速確認：這個化學品的主要危害是什麼、嚴重程度幾級。以丙酮為例，這節應該看到「易燃液體 第2級」、「眼睛刺激物 第2級」、「特定標的器官毒性 第3級（中樞神經）」。</p>

   <p><b>第 4 節：急救措施</b><br>
   按照暴露途徑分成四個子項：吸入、皮膚接觸、眼睛接觸、食入。緊急應變時不用全部讀完，直接找對應的暴露途徑。丙酮大量吸入的急救措施是「移到新鮮空氣處，若呼吸困難給予氧氣，若不呼吸進行人工呼吸，立即就醫」。這節要在事故發生「之前」讀熟，不是出事了才翻。</p>

   <p><b>第 7 節：安全處置與儲存</b><br>
   涵蓋操作時的防護措施（通風要求、靜電接地、禁止明火）和儲存條件（溫度上限、不相容物質、容器材質要求）。易燃溶劑在這節通常會要求「遠離熱源和點火源、儲存於通風良好且防爆的場所、與氧化劑分開儲存」。這節是職安衛法規鑑別時「製程安全管理」面向的重要依據。</p>

   <p><b>第 8 節：暴露預防措施</b><br>
   這節有兩個關鍵資料：<b>容許暴露標準（PEL/OEL）</b>和<b>個人防護設備（PPE）規格</b>。丙酮的法定 8 小時時量平均容許濃度（TWA）是 750 ppm，如果你的廠房沒有裝通風設備、作業人員又沒戴有機氣體濾毒罐，光是氣味讓人頭暈就代表可能已經超標。PPE 欄位會指定手套材質（如丁腈橡膠、氯丁橡膠而非普通橡膠手套），買錯材質等於沒戴。</p>

   <hr style="border:none;border-top:1px solid var(--border);margin:24px 0">

   <h4>七、三個時間點的實務確認清單</h4>

   <div class="tip-box tip-goal">🎯 把以下清單印出來貼在化學品倉庫門口，或做成現場教育訓練的確認表。</div>

   <p><b>① 入廠前／採購新化學品時</b></p>
   <ul style="margin:8px 0 16px 20px;line-height:2">
     <li>確認供應商是否提供最新版 SDS（SDS 應在第 16 節載明版本日期）</li>
     <li>確認 SDS 是中文版，且版本不超過 5 年（法規修訂或製程改變時應更新）</li>
     <li>核對容器標示的危害分類是否與 SDS 第 2 節一致</li>
     <li>確認儲存條件（第 7 節）與現有倉儲設施是否相符</li>
   </ul>

   <p><b>② 現場作業前</b></p>
   <ul style="margin:8px 0 16px 20px;line-height:2">
     <li>確認現場標示完整（象形圖、警示語、化學品名稱）且與 SDS 一致</li>
     <li>對照第 8 節確認 PPE 規格：手套材質、呼吸防護是否正確</li>
     <li>確認通風設備正常運作（對照第 7 節的通風要求）</li>
     <li>確認急救設備位置與第 4 節的急救措施一致（如洗眼站距離）</li>
   </ul>

   <p><b>③ 新進人員教育訓練</b></p>
   <ul style="margin:8px 0 16px 20px;line-height:2">
     <li>教導員工如何從象形圖判斷危害類型</li>
     <li>示範如何快速查閱 SDS 第 4 節（急救措施）和第 8 節（PPE 規格）</li>
     <li>定期盤點現場所有化學品，確認每一種都有對應且有效的 SDS</li>
   </ul>

   <div class="tip-box tip-info">💡 <b>法規提醒</b>：依《危害性化學品標示及通識規則》第 17 條，雇主應確保作業場所所使用危害性化學品均有對應的安全資料表，並置於工作場所容易取得的地方。SDS 遺失或過期未更新，在職安衛稽查時都是常見的缺失項目。</div>

   <p style="margin-top:24px">GHS 和 SDS 這兩套工具，用意從來不是讓你把 16 頁全背起來——而是讓你在「需要的時間點」知道去哪裡找對的資訊。現場出事時，不會有時間重新翻規定；但如果平時教育訓練做得紮實，員工知道「吸入了看第 4 節、要買手套看第 8 節、儲存條件看第 7 節」，這份文件的價值才真正發揮出來。下次拿到一份新化學品，試著從象形圖開始讀，再對到 SDS 的危害辨識——不用 5 分鐘，你就知道它的底細了。</p>`}
];
